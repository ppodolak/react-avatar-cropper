...
class Cropper extends React.Component {
  ...
  prepareImage (imageUri) {
    ...
    img.onload = () => {
      ...
      scaledImage.x = 0;
      scaledImage.y = 0;
      this.setState({dragging: false, image: scaledImage, preview: this.toData()});
    };
    img.src = imageUri;
  }
  ...
  mouseUpListener (e) {
    this.setState({ dragging: false, preview: this.toData() });
  }
...
Cropper.propTypes = {
    ...
    zoom: numberableType,
    returnBlob: React.PropTypes.bool
};
Cropper.defaultProps = { width: 400, height: 400, zoom: 1, returnBlob: false };
        ...
        <div className="modal-body">
          ...
          <div className="AvatarCropper-base">
            <Cropper
              ...
              returnBlob={this.props.returnBlob}
            />
          </div>
...
AvatarCropper.defaultProps = { width: 400, height: 400, modalSize: "large", returnBlob: false };
